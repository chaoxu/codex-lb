...
| 2 | `upstream-connect-within-stream-budget` | GROUNDED | Wrong connect anchor family | Kept; anchor fixed to `app/core/clients/proxy.py:2720`. |
...
| 14 | `sse-keepalive-within-stream-budget` | GROUNDED | None | Kept. |
| 15 | `sse-keepalive-within-bridge-budget` | GROUNDED | None | Kept. |
| 16 | `token-refresh-claim-covers-admission-and-exchange` | GROUNDED | None | Kept. |
...
| 18 | `token-refresh-exchange-within-claim-ttl` | GROUNDED | None | Kept. |
...
| 27 | `bridge-clean-close-jitter-within-bridge-budget` | GROUNDED | None | Kept. |
